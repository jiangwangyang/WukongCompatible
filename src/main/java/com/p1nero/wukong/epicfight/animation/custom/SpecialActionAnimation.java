...
public class SpecialActionAnimation extends ActionAnimation {
    public SpecialActionAnimation(float convertTime, AnimationManager.AnimationAccessor<? extends ActionAnimation> accessor, AssetAccessor<? extends Armature> armature) {
        this(convertTime, Float.MAX_VALUE, accessor, armature);
    }

    public SpecialActionAnimation(float convertTime, float postDelay, AnimationManager.AnimationAccessor<? extends ActionAnimation> accessor, AssetAccessor<? extends Armature> armature) {
